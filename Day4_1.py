...
def day4_1(input):
  ...
  print (most_asleep[str(most_asleep_guard)].most_common()[0][0])
  most_asleep_minute = most_asleep[str(most_asleep_guard)].most_common()[0][0]
  time_struct = most_asleep_minute.split(":")
  minute_number = int(time_struct[0]) * 60 + int(time_struct[1])
    
  return most_asleep_guard * minute_number

assert(day4_1(testdata_unsorted) == 240)
print (day4_1(input))