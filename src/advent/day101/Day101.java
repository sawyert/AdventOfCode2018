...
public class Day101 {
	private static final String INPUT = "position=< 42772, -21149> velocity=<-4,  2>\n" + "position=< 42804, -31790> velocity=<-4,  3>\n"
	...
	private static final String TESTDATA = "position=< 9,  1> velocity=< 0,  2>\n" + "position=< 7,  0> velocity=<-1,  0>\n"
	...
	public static void main(String[] argv) {
		Day101 day = new Day101();
		day.execute(Day101.INPUT);
	}

	private void execute(String testdata) {
		Grid grid = new Grid();
		grid.init(testdata);
		for (int i = 0; i <= 10644; i++) {
			grid.tick();
			grid.printGridDimensions();
		}
		grid.printGrid();
	}
}
